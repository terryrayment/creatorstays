    ...
    <footer className="bg-black px-3 pb-4 pt-2 lg:px-4">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-2 md:grid-cols-[1.5fr_1fr_1fr]">
          ...
          {/* CTA block - Blue (without Host Signup since user is already signed up) */}
          <div className="rounded-2xl border-[3px] border-black bg-[#4AA3FF] p-5">
            ...
            <div className="mt-3 space-y-2">
              <Link
                href="/help"
                className="flex h-9 items-center justify-center rounded-full border-[3px] border-black bg-black text-[9px] font-black uppercase tracking-wider text-white transition-transform duration-200 hover:-translate-y-0.5"
              >
                Help Center
              </Link>
              <Link
