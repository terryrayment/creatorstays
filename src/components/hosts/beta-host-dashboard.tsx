        ...
        <div className="space-y-6">
          ...
          <Section title="Quick Links">
            <div className="space-y-1.5">
              ...
              <Link href="/how-to/hosts" className="flex items-center justify-between rounded-lg bg-[#FAFAFA] px-3 py-2 text-xs text-black transition-colors hover:bg-black/10">
                Host Guide
                <span className="text-black/40">→</span>
              </Link>
              <Link href="/help" className="flex items-center justify-between rounded-lg bg-[#FAFAFA] px-3 py-2 text-xs text-black transition-colors hover:bg-black/10">
                Help Center
                <span className="text-black/40">→</span>
              </Link>
            </div>
