...
// 3D-style Phone + Link Tag illustration
            ...
            >
              {feature.isDashboard ? (
                <div className="flex h-full flex-col">
                  <h3 className="font-heading text-[1.75rem] leading-[0.85] tracking-[-0.02em] text-black sm:text-[2rem]">
                    {feature.title}
                  </h3>
                  <p className="mt-2 text-[12px] font-medium text-black/50">{feature.subtitle}</p>
                ...
                <div className="flex h-full flex-col justify-between">
                  <div>
                    <h3 className="font-heading text-[2.5rem] leading-[0.85] tracking-[-0.03em] text-black sm:text-[3rem] md:text-[3.5rem]">
                      {feature.title}
                    </h3>
                    <p className="mt-2 text-[13px] font-medium text-black/50">{feature.subtitle}</p>
                  </div>
