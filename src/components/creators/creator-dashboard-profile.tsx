      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_300px]">
          <div className="space-y-4">
                ...
                <div className="border-b border-black/10 bg-white p-5 md:w-56 md:border-b-0 md:border-r">
                  ...
                  <div className="mt-4 flex flex-col gap-2 border-t border-black/10 pt-4">
                    ...
                    <div className="flex items-center gap-2 text-xs text-black">
                      ...
                      <span>Ready to receive offers</span>
                    </div>
                    <div className="flex items-center gap-2 text-xs text-black">
                      <StatusDot active={Object.keys(connectedPlatforms).length > 0} color="bg-blue-500" />
                      <span>{Object.keys(connectedPlatforms).length > 0 ? 'Socials connected' : 'Connect socials'}</span>
                    </div>
                  </div>
            ...
            {/* Collaborations Empty State - replaces fake Campaign Timeline */}
            <Panel variant="elevated">
          ...
          {/* Right sidebar */}
          <div className="space-y-4">
            {/* Earnings - Show setup state until Stripe connected */}
            ...
            {/* Messaging Info - Beta restriction notice */}
            <Panel>
            ...
            {/* Offers - Empty state when no real offers */}
            <Panel>
