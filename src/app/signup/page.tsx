...
import { Mail, ArrowLeft, Home, Users, Check } from 'lucide-react';
...
function SignupForm() {
  ...
  const handleEmailSignUp = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    // This would call the NextAuth signIn function with email
    // and store the role selection for after verification
  ...
  const handleGoogleSignUp = async () => {
    ...
    setIsLoading(true);
    // This would call signIn('google', { callbackUrl: `/onboarding?role=${selectedRole}` })
    await new Promise(resolve => setTimeout(resolve, 1000));
    setIsLoading(false);
  };
    ...
    <div className="w-full max-w-md space-y-8">
      ...
      <Card>
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Join the marketplace for creators and vacation rentals
          </CardDescription>
        </CardHeader>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div className={cn(
                  ...
                  selectedRole === 'creator' ? 'bg-sage-500 text-white' : 'bg-sage-100 text-sage-600'
                )}>
              ...
              <button
                ...
                className={cn(
                  ...
                  selectedRole === 'host'
                    ...
                    : 'border-border hover:border-coral-300 hover:bg-coral-50/50'
                )}
              >
                {selectedRole === 'host' && (
                ...
                <div className={cn(
                  'w-10 h-10 rounded-lg flex items-center justify-center mb-2',
                  selectedRole === 'host' ? 'bg-coral-500 text-white' : 'bg-coral-100 text-coral-600'
                )}>
            ...
            <>
              ...
              <form onSubmit={handleEmailSignUp} className="space-y-4">
                ...
                <Button 
                  ...
                  className="w-full h-12" 
                  disabled={isLoading}
                  variant={selectedRole === 'host' ? 'coral' : 'sage'}
                >
                  {isLoading ? (
