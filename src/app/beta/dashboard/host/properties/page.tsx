              ...
              {editing && !editing.isNew && selectedId && editorStep === 3 && (
                <div className="rounded-xl border-2 border-black bg-white p-4">
                  <div className="flex items-start justify-between">
                    ...
                    <span className="rounded-full border-2 border-[#28D17C] bg-[#28D17C] px-2 py-0.5 text-xs font-bold text-black">$49/mo</span>
                  </div>
                  
                  {(editing as Property).isBoosted ? (
                    <div className="mt-4">
                      <div className="flex items-center gap-2 rounded-lg border-2 border-[#28D17C] bg-[#28D17C] px-3 py-2">
