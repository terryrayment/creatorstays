...
function StatCard({ label, value, subtext, variant = "default" }: { 
  ...
  value: string | number
  subtext?: string
  variant?: "default" | "yellow" | "green" | "blue"
}) {
  const bgColors = {
    default: "bg-white",
    yellow: "bg-[#FFD84A]",
  ...
  return (
    <div className={`rounded-xl border-2 border-black ${bgColors[variant]} p-4 transition-transform hover:-translate-y-0.5`}>
      ...
      <div className="flex-1 px-3 py-4 lg:px-4">
        <div className="mx-auto max-w-6xl space-y-3">
          ...
          <div className="rounded-xl border-2 border-black bg-white p-4">
            <Link href="/beta/dashboard/host" className="text-xs font-bold text-black/60 hover:text-black">← Dashboard</Link>
          ...
          <div className="grid gap-3 lg:grid-cols-2">
            ...
            <div className="rounded-xl border-2 border-black bg-white p-5">
              ...
              <div className="mt-4 flex items-end justify-around gap-2 h-32">
                {DEMO_STATS.clicksByMonth.map((month) => (
                  <div key={month.month} className="flex flex-col items-center gap-1">
                    <div 
                      className="w-12 bg-[#4AA3FF] border-2 border-black rounded-t transition-all"
              ...
              <div className="mt-4 rounded-lg border-2 border-black bg-black/5 p-3 text-center">
            ...
            <div className="rounded-xl border-2 border-black bg-white p-5">
              ...
              <div className="mt-4 flex items-center gap-4">
                <div className="flex h-16 w-16 items-center justify-center rounded-full border-2 border-black bg-[#28D17C] text-xl font-bold text-black">
                  EW
                </div>
                <div className="flex-1">
              ...
              <div className="mt-4 rounded-lg border-2 border-black bg-[#28D17C]/30 p-3">
          ...
          <div className="rounded-xl border-2 border-black bg-white p-5">
            ...
            <div className="mt-4 space-y-3">
              {DEMO_STATS.clicksByProperty.map((prop) => (
                <div key={prop.property} className="flex items-center gap-4 rounded-lg border-2 border-black bg-white p-3">
                  <div className="flex-1">
                  ...
                  <div className="w-32">
                    <div className="h-3 rounded-full border-2 border-black bg-white overflow-hidden">
                      <div 
                        className="h-full bg-[#4AA3FF] transition-all"
                        style={{ width: `${Math.max((prop.clicks / DEMO_STATS.totalClicks) * 100, 2)}%` }}
                      />
                    </div>
                  </div>
          ...
          <div className="rounded-xl border-2 border-dashed border-black/40 bg-white p-6 text-center">
