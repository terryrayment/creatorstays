    ...
    <div className="min-h-screen">
      ...
      <div className="border-b border-black/5 bg-white/50 backdrop-blur-sm">
        <div className="mx-auto flex h-11 max-w-6xl items-center justify-between px-4 sm:px-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-black/60">Analytics</span>
          </div>
      ...
      <Container className="py-8">
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-black/60">Track clicks and visitor activity across all your collaborations.</p>
        </div>
