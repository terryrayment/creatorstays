    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="bg-black">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:px-6">
          ...
          <Link href="/dashboard/creator" className="rounded-full border-[2px] border-black bg-white px-4 py-1 text-[10px] font-black uppercase tracking-wider text-black hover:-translate-y-0.5 transition-transform">← Back to Dashboard</Link>
        </div>
      </div>
