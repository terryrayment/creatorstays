      ...
      <div className="border-b-2 border-black bg-white">
        <div className="mx-auto flex h-12 max-w-6xl items-center justify-between px-4 sm:px-6">
          <div className="flex items-center gap-3">
            ...
            <Link href="/dashboard/host" className="text-sm font-bold text-black hover:text-[#28D17C]">Host Dashboard</Link>
          </div>
          <Link 
            href="/" 
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border-2 border-black bg-white p-5 min-h-[450px]">
              ...
              <div className="space-y-1.5">
                ...
                <Link href="/dashboard/host/preferences" className="flex items-center justify-between rounded-lg border-2 border-black bg-white px-3 py-2 text-xs font-bold text-black transition-all hover:-translate-y-0.5">
                  Creator Preferences
                  <span className="text-black/40">→</span>
                </Link>
            ...
            <div className="rounded-xl border-2 border-dashed border-black/20 bg-[#FAFAFA] p-4 text-center">
              ...
              <a 
                ...
                className="mt-1 inline-block text-sm font-bold text-black hover:text-[#28D17C]"
              >
