    ...
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      <div className="border-b-2 border-black bg-[#FFD84A]">
        <div className="mx-auto flex h-12 max-w-6xl items-center justify-between px-4 sm:px-6">
          ...
          <Link href="/dashboard/host" className="rounded-full border-2 border-black bg-white px-4 py-1 text-[10px] font-black uppercase tracking-wider text-black transition-transform hover:-translate-y-0.5">← Back to Dashboard</Link>
        </div>
      </div>
