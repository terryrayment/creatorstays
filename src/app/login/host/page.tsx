        ...
        <div className="mx-auto max-w-md">
          <div className="rounded-2xl border-[3px] border-black bg-[#28D17C] p-6 text-center">
            ...
            <p className="mt-2 text-[11px] text-black/70">
              Click the link in the email to access your host dashboard. The link expires in 24 hours.
            </p>
            <button
    ...
    <div className="min-h-screen bg-black px-3 pt-16 pb-8 lg:px-4">
      <div className="mx-auto max-w-md">
        <div className="rounded-2xl border-[3px] border-black bg-white p-6">
          ...
          {/* Error Messages */}
          {(error || errorParam) && (
            <div className="mt-4 rounded-lg border-2 border-red-300 bg-red-50 p-3 text-center">
          ...
          <div className="my-5 flex items-center gap-3">
            ...
            <span className="text-[10px] font-bold uppercase tracking-wider text-black/40">or</span>
            <div className="h-[2px] flex-1 bg-black/10" />
          </div>
